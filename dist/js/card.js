    ...
    methods: {
                ...
                __WEBPACK_IMPORTED_MODULE_0_highcharts___default.a.setOptions({
                    colors: __WEBPACK_IMPORTED_MODULE_0_highcharts___default.a.map(__WEBPACK_IMPORTED_MODULE_0_highcharts___default.a.getOptions().colors, function (color) {
                        return {
                            ...
                            stops: [[0, color], [1, __WEBPACK_IMPORTED_MODULE_0_highcharts___default.a.Color(color).brighten(-0.3).get('rgb')] // darken
                            ]
                        };
                    })
                });
        ...
        reload: function reload() {
            if (this.options && this.options.chart) {
                this.loadGradient();
                new __WEBPACK_IMPORTED_MODULE_0_highcharts___default.a.chart(this.options);
            }
        }
    }
});
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("div", {
        staticClass: "pin rounded-b-lg ct-chart",
        staticStyle: { top: "60%" },
        style: { height: _vm.card.height },
        attrs: { id: _vm.card.uriKey }
      })
    ]
  )
}
